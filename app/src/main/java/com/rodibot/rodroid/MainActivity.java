...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageButton mAccelerometerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAccelerometerView = (ImageButton) findViewById(R.id.accelerometer);
        mAccelerometerView.setOnClickListener(new View.OnClickListener() {
            @Override
